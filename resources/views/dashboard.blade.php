        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <section class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
                ...
                <div class="mx-auto max-w-2xl lg:max-w-4xl">
                    <x-application-mark class="mx-auto h-12" />
                    ...
                    <figure class="mt-10">
                        <blockquote
                            ...
                            <p>Esperamos que disfrutes nuestro sitio</p>
                            <p>y logres encontrar tu piso ideal."</p>
                        </blockquote>
                        <figcaption class="mt-10">

                            <div class="mt-4 flex items-center justify-center space-x-3 text-base">
                                <div class="font-semibold text-gray-900">Antony Gibellini </div>
                                <svg viewBox="0 0 2 2" width="3" height="3" aria-hidden="true"
                                    class="fill-gray-900">
                                    <circle cx="1" cy="1" r="1" />
                                </svg>
                                <div class="text-gray-600">Creador de Tu pisito</div>
                            </div>
                        </figcaption>
                    </figure>
                </div>
